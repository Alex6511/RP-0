            ...
            for (int j = 0; j < _parts.Count; j++)
            {
                ...
                for (int i = 0; i < p.CrewCapacity; i++)
                {
                    ...
                    if (i < launchedCrew.Count && launchedCrew[i] != null)
                    {
                        ...
                        launchedCrew[i].HasChute = GUILayout.Toggle(launchedCrew[i].HasChute, new GUIContent("P", "Parachute"), GUILayout.ExpandWidth(false), GUILayout.Height(20));
                        launchedCrew[i].HasJetpack = GUILayout.Toggle(launchedCrew[i].HasJetpack, new GUIContent("E", "EVA pack"), GUILayout.ExpandWidth(false), GUILayout.Height(20));
